...
class boid :
	...
	# def __init__(self, position =[0.,0.], velocity=[0.,0.], rseek=120, rfollow=80, rflee=40, color=[255,255,255,255]):
		self.id = boid.nextid
		boid.nextid += 1
	...
	def updateVelocity(self, x_pos, y_pos, x_vel, y_vel) :
		...
		# vel2 = self.reaction2(x_pos, y_pos, x_vel, y_vel)
...
if __name__ == "__main__" :
	...
	# boid([300, 100], [0,0], color=(255, 0, 255))
